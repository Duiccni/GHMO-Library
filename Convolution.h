	...
	option_t complex_nine_convolution(surface& surf, three_3d_matrix& value)
	{
		...
		// middle
		sums.blue.x22 = sums.blue.x32 + value.blue.x11 + value.blue.x12 + value.blue.x13;
		sums.green.x22 = sums.green.x32 + value.green.x11 + value.green.x12 + value.green.x13;
		sums.red.x22 = sums.red.x32 + value.red.x11 + value.red.x12 + value.red.x13;
